...
var CreateVendor = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, ownerName, foodType, address, email, password, phone, pincode, existingVendor, salt, userPassword, createdVendor;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, ownerName = _a.ownerName, foodType = _a.foodType, address = _a.address, email = _a.email, password = _a.password, phone = _a.phone, pincode = _a.pincode;
